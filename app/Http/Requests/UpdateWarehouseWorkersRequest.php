...
class UpdateWarehouseWorkersRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'warehouse_id.required' => 'Manzil ID maydoni to\'ldirilishi kerak.',
            'warehouse_id.integer' => 'Manzil ID butun son bo\'lishi kerak.',
        ];
    }
}
